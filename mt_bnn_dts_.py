...
# outres1 = open('mt_result_sunspot_inp1.txt', "a+")
# outres2 = open('mt_result_sunspot_inp1_w.txt', "a+")
# outres3 = open('mt_result_sunspot_inp1_submodel2.txt', "a+")
# outres4 = open('mt_result_sunspot_inp1_submodel3.txt', "a+")
# outres5 = open('mt_result_sunspot_inp1_output.txt', "a+")
...
#size of each subtask
    ...
    #Ok, in this case, we only consider the number of hidden neurons increasing for each subtask. Input neurons and output neuron remain fixed in this version.
        ...
        naccept = np.zeros(self.subtasks)
    ...
    ## PROPOSE FOR PARAMS of MODEL M theta_m
        ...
        for i in range(1, samples-1):    # ---------------------------------------
            ...
            trainfx_mean = np.reshape(scipy.mean(trainfx[0,:]), (1,1))
            trainfx_mean_2 = np.reshape(scipy.mean(trainfx[1,:]), (1,1))
            trainfx_mean_3 = np.reshape(scipy.mean(trainfx[2,:]), (1,1))
            # np.savetxt(outres1, (trainfx_mean), fmt='%1.5f')
            # np.savetxt(outres3, (trainfx_mean_2), fmt='%1.5f')
            # np.savetxt(outres4, (trainfx_mean_3), fmt='%1.5f')

            # np.savetxt(outres1, (trainfx[1,:]), fmt='%1.5f')
            # np.savetxt(outres1, (trainfx[2,:]), fmt='%1.5f')
            testfx_mean = np.reshape(scipy.mean(testfx[0,:]), (1,1))
            testfx_mean_2 = np.reshape(scipy.mean(testfx[1,:]), (1,1))
            testfx_mean_3 = np.reshape(scipy.mean(testfx[2,:]), (1,1))
            # np.savetxt(outres1, (testfx_mean), fmt='%1.5f')
            # np.savetxt(outres3, (testfx_mean_2), fmt='%1.5f')
            # np.savetxt(outres4, (testfx_mean_3), fmt='%1.5f')

            # np.savetxt(outres1, (testfx_mean), fmt='%1.5f')
            # np.savetxt(outres1, (testfx[1,:]), fmt='%1.5f')
            # np.savetxt(outres1, (testfx[2,:]), fmt='%1.5f')



        # print(naccept, ' num accepted')
        accept_ratio = naccept / (samples) * 100
...
def main():
    ...
    for problem in range(2, 3):
        ...
        for s in range(0, subtasks):
            ...
            # np.savetxt(outres2, (w_pos[:,s,0]), fmt='%1.5f')
        ...
        np.savetxt(outres, (problem), fmt='%1.1f')
        ...
        # np.savetxt(outres5, (fx_mu), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low), fmt='%1.5f')
        ...
        # np.savetxt(outres5, (fx_mu_tr), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high_tr), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low_tr), fmt='%1.5f')
        ...
        # np.savetxt(outres5, (fx_mu1), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high1), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low1), fmt='%1.5f')
        ...
        # np.savetxt(outres5, (fx_mu_tr1), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high_tr1), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low_tr1), fmt='%1.5f')
        ...
        # np.savetxt(outres5, (fx_mu2), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high2), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low2), fmt='%1.5f')
        ...
        # np.savetxt(outres5, (fx_mu_tr2), fmt='%1.5f')
        # np.savetxt(outres5, (fx_high_tr2), fmt='%1.5f')
        # np.savetxt(outres5, (fx_low_tr2), fmt='%1.5f')
